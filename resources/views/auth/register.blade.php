        ...
        <div class="container position-absolute translate-middle start-50 top-50">
            <div class="card p-5 shadow p-3 mb-5 bg-white rounded d-flex justify-content-center">
                ...
                <form class="mt-5" action="/register" method="POST">
                    ...
                    <table style="width: 100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control my-1 @error('name') is-invalid @enderror" id="inputUsername" placeholder="username" name="name" required>
                                    @error('name')
                            ...
                            <tr>
                                <td><label for="inputPasswordConfirmation" class="form-label">Password Confirmation</label></td>
                                <td>
                    ...
                    <p class="mt-3">Sudah punya akun? <a href="/login">masuk di sini!</a></p>
                    <button type="submit" class="btn btn-primary my-2 d-flex ms-auto">Register</button>
                </form>
            </div>
